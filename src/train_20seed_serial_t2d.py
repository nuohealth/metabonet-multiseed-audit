...
# -*- coding: utf-8 -*-
"""
ShanghaiT2DM T2D 多seed消融 — 补足到20个seed (论文#5 → CMPB)
- SEEDS: 42..61 (20个)
...
# ---------- 配置 ----------
DATA_PATH=os.path.join(BASE_DIR, 'data', 't2d', 't2d_metabonet_data.npz')
OUT_DIR=os.path.join(BASE_DIR, 'results', 'metabonet_v2_20seed_t2d')
DEVICE='cpu'
